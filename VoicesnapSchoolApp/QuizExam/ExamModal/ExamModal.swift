...
class ExamData: Mappable {
    ...
    var TimeForQuestionReading : String!
    var ExamDate : String!
    var isShow : String!
    ...
    func mapping(map: Map) {
        ...
        ExamStartTime <- map["ExamStartTime"]
        
        ExamEndTime <- map["ExamEndTime"]
        TimeForQuestionReading <- map["TimeForQuestionReading"]
