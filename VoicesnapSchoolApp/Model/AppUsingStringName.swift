...
class commonStringNames {
    ...
    static let CertificateOnly = "Certificate"
    static let RequestOnly = "Request"
    ...
    static let SubmittedOn = "Submitted On"
   ...
   // MARK: old school
    ...
    static let to_voicesnap = "Savyasasy"
    ...
    static let studentReportStandard = "Select Standard"
    static let studentReportSection = "Select Section"
    ...
    static let EmergencyVoiceMessageInfo = "You can record emergency voice message up to 30 seconds"
    static let PressToRecord = "Press the button to RECORD"
    static let AddMp3File = "Add file(mp3)"
    static let InstantCall = "Instant call"
    static let ScheduleCall = "Schedule Call"
    static let RecordUpTo3Minutes = "You can record up to 3 minutes"
    static let InitiateCallOn = "Initiate call on"
    static let DoNotDialBeyond = "Do not dial beyond"
    static let SelectedDates = "Selected Dates"
    static let NoMessagesToday = "There are no Messages for today. Click “See More” for previous"
    static let SeeMore = "See More"
    static let HomeworkReport = "Homework Report"
    static let AddAttachments = "ADD ATTACHMENTS"
    static let AttendanceType = "Attendance Type"
    static let Or = "Or"
    //static let ComposeNoticeBoard = "Compose Notice Board"
    static let SEND = "SEND"
    static let NoMessagesForDay = "No messages for the day. Click “See More” for previous message"
    static let DateTime = "Date Time"
    //static let MessagesFromManagement = "Messages from Management"
    static let MarkAttendance = "Mark Attendance"
    static let YourAttendanceDetails = "Your Attendance Details"

    static let AttendanceOutsideBoundaryNote = "Note: You are outside the institute's boundary. You will not be able to mark your attendance."
    static let RetryWithinDesignatedArea = "Please try again when you are within the designated area."

    static let AddNewPunchLocation = "Add new punch location"
    static let EnterPasscode = "Enter iPhone Passcode for “School Chimes”"
    static let AuthenticateToProceed = "Please Authenticate to proceed"

    static let ImportantNote = "Important"
    static let AccurateLocationSettingsMessage = "Accurate location settings are crucial for ensuring that attendance is only marked when users are within the designated area of the institute. Please double check the location before submitting."
    static let SavedLocationUsageMessage = "Once saved, this location will be used to verify the proximity of users when they mark their attendance. Ensure that location is correct as it will directly impact attendance functionality."

    static let PinYourLocationName = "Pin Your Location Name"
    ...
    static let AllowLocationToMarkAttendance = "Allow location access to mark your attendance!"
    static let EnableGPSForBetterFeatures = "To enhance your experience and provide accurate location-based features, please enable GPS."
    static let EnableLocation = "Enable Location"

    static let Attachment = "Attachment"
    static let type = "Type"
    static let ViewAttachment = "View Attachment"
    static let Next = "Next"
    static let PreviewLSRW = "Preview LSRW"
    static let SubmitLSRW = "Submit LSRW"
    static let AddContent = "Add Content"
    
    static let MeetingPlatform = "Meeting Platform"
    static let SelectMeetingPlatform = "SELECT MEETING PLATFORM"
    static let SelectTime = "Select Time"
    static let PasteLink = "Paste link"
    static let NewProducts = "New Products"

    static let FeedbackToVoicesnap = "Feedback to Voicesnap"
    static let SchoolName = "School Name"
    static let YourName = "Your Name"
