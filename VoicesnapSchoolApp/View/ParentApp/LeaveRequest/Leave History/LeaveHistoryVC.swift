...
class LeaveHistoryVC: UIViewController ,UITableViewDelegate,UITableViewDataSource,Apidelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.performSegue(withIdentifier: "HistoryPopoverSegue", sender: self)
    }
    ...
    func GetLeaveHistoryApiCalling()
    {
        ...
        let myDict:NSMutableDictionary = ["ReqId" : ChildIDString,"type" : "student", COUNTRY_CODE: strCountryCode]
        
        print("LEAVEREQUEST",requestString)
    ...
    func navTitle()
    {
        ...
        let secondWord : String  = commonStringNames.leave.translated() as? String ?? "Leave"//"Staff "
        let thirdWord  : String   = languageDictionary["history"] as? String ?? "History"
    ...
    {
        if (segue.identifier == "HistoryPopoverSegue")
        {
            let segueid = segue.destination as! LeaveHistoryPopupVC
    ...
    func loadViewData(){
        self.title = commonStringNames.leave_history as? String
