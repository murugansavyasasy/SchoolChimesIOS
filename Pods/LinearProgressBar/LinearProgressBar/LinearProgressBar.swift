...
open class LinearProgressBar: UIView {
    ...
    @IBInspectable public var barColor: UIColor = UIColor(named: "LessonGreen")!
    /// The color of the base layer of the bar
    @IBInspectable public var trackColor: UIColor = UIColor.yellow
    /// The thickness of the bar
    @IBInspectable public var barThickness: CGFloat = 100
    /// Padding on the left, right, top and bottom of the bar, in relation to the track of the progress bar
    @IBInspectable public var barPadding: CGFloat = 1
    @IBInspectable public var percentageLbl: String!
    /// Padding on the track on the progress bar
    @IBInspectable public var trackPadding: CGFloat = 1 {
        didSet {
            if trackPadding < 0 {
                trackPadding = 0
...
//        percentageLbl = CGPoint(x: frame.size.width - barPadding - trackOffset, y: frame.size.height / 2)
        // Progress bar
